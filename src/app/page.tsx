          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="absolute -inset-4 pointer-events-none">
                ...
                <div className="absolute top-1/2 right-0 w-16 h-16 border-r-2 border-t-2 border-border transform -translate-y-1/2" />
              ...
              <div className="relative aspect-square max-w-lg mx-auto">
                <div className="relative overflow-hidden rounded-b-lg bg-cyber-black">
                  <img
                    src="/hero-ai3.png"
                  ...
                  {/* decorations on the top of the image */}
                  <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-1/3 w-1/3 border border-primary/40 rounded-full" />
